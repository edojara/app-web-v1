...
<form method="POST" style="background-color: white; padding: 2rem; border-radius: 8px; max-width: 500px;">
    <div style="margin-bottom: 1.5rem;">
        ...
        <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($user['name']); ?>" required style="width: 100%; padding: 0.8rem; border: 1px solid #ddd; border-radius: 4px; font-size: 1rem;">
    </div>
    
    <div style="margin-bottom: 1.5rem;">
        <label for="email" style="display: block; font-weight: bold; margin-bottom: 0.5rem;">Email:</label>
        <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($user['email']); ?>" required style="width: 100%; padding: 0.8rem; border: 1px solid #ddd; border-radius: 4px; font-size: 1rem;">
    </div>
    ...
    <div style="margin-bottom: 1.5rem;">
        <label for="estado" style="display: block; font-weight: bold; margin-bottom: 0.5rem;">Estado:</label>
        <select id="estado" name="estado" required style="width: 100%; padding: 0.8rem; border: 1px solid #ddd; border-radius: 4px; font-size: 1rem;">
    ...
    <div>
        <button type="submit" class="btn btn-success" style="display: inline-block; margin-right: 0.5rem;">Guardar Cambios</button>
