...
class HomeController {
    ...
    public function index() {
        ...
        $topInstitucionesParticipantes = $this->getTopInstitucionesPorParticipantes(5);
        
        // Obtener top 5 instituciones con más asistencia a eventos
        $topInstitucionesAsistencia = $this->getTopInstitucionesPorAsistencia(5);
     ...
     */
    private function getTopInstitucionesPorParticipantes($limit = 5) {
        global $conn;
